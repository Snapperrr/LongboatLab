...
execute if score #mounted lr_tmp matches 1 on vehicle run longboatlab race_move 228.8 66 190.7 -180.0
execute if score #mounted lr_tmp matches 0 run tp @s 228.8 66 190.7 -180.0 0
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_a] run kill @e[type=minecraft:boat,tag=lr_boat_a]
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_a] run summon minecraft:boat 228.8 66 190.7 {Type:"oak",Tags:["lr_raceboat","lr_boat_a"],Rotation:[-180.0f,0f],LongboatRig:{Segments:1,Width:1,LeftCount:1,RightCount:1,Compressed:0b,Puffers:0}}
...
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_b] run summon minecraft:boat 228.8 66 190.7 {Type:"oak",Tags:["lr_raceboat","lr_boat_b"],Rotation:[-180.0f,0f],LongboatRig:{Segments:1,Width:1,LeftCount:1,RightCount:1,Compressed:0b,Puffers:0}}
