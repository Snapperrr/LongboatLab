...
execute positioned 17 64 73 unless entity @s[distance=..8] run return 0
execute if score @s lr_pit0 = #round lr_epoch run return 0
...
scoreboard players operation @s lr_pit0 = #round lr_epoch
