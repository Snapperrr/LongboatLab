...
execute positioned 310 64 1 unless entity @s[distance=..8] run return 0
execute if score @s lr_p2_oars = #round lr_epoch run return 0
...
scoreboard players operation @s lr_p2_oars = #round lr_epoch
