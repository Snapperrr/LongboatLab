...
execute as @a[tag=lr_racer,scores={lr_cp=36,lr_place=0}] at @s run function puffer_rally:nav_36
execute as @a[tag=lr_racer,scores={lr_cp=37,lr_place=0}] at @s run function puffer_rally:nav_37
execute as @a[tag=lr_racer,scores={lr_cp=38,lr_place=0}] at @s run function puffer_rally:nav_38
execute as @a[tag=lr_racer,scores={lr_cp=39,lr_place=0}] at @s run function puffer_rally:nav_39
execute as @a[tag=lr_racer,scores={lr_cp=40,lr_place=0}] at @s run function puffer_rally:nav_40
execute as @a[tag=lr_racer,scores={lr_cp=41,lr_place=0}] at @s run function puffer_rally:nav_41
execute as @a[tag=lr_racer,scores={lr_cp=42,lr_place=0}] at @s run function puffer_rally:nav_42
