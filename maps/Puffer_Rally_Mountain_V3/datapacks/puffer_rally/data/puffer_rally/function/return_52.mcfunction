...
execute if score #mounted lr_tmp matches 1 on vehicle run tp @s 2631.56 148 1621.27 -37.62 0
...
execute if score #mounted lr_tmp matches 0 run tp @s 2631.56 148 1621.27 -37.62 0
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_a] run kill @e[type=minecraft:boat,tag=lr_boat_a]
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_a] run summon minecraft:boat 2631.56 148 1621.27 {Type:"oak",Tags:["lr_raceboat","lr_boat_a"],Rotation:[-37.62f,0f],LongboatRig:{Segments:1,Width:1,LeftCount:1,RightCount:1,Compressed:0b,Puffers:0}}
...
execute if score #mounted lr_tmp matches 0 if entity @s[tag=lr_b] run summon minecraft:boat 2631.56 148 1621.27 {Type:"oak",Tags:["lr_raceboat","lr_boat_b"],Rotation:[-37.62f,0f],LongboatRig:{Segments:1,Width:1,LeftCount:1,RightCount:1,Compressed:0b,Puffers:0}}
