...
execute positioned -24 64 -20 run summon minecraft:boat -24 63.85 -20 {Type:"oak",Tags:["lr_raceboat","lr_boat_a"],Rotation:[0f,0f],Invulnerable:0b,LongboatRig:{Segments:4,Width:1,LeftCount:8,RightCount:8,Compressed:1b,Puffers:0}}
tp @s -24 64 -20 0 0
ride @s mount @e[type=minecraft:boat,tag=lr_boat_a,limit=1,sort=nearest]
gamemode survival @s
