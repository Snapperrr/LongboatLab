...
execute positioned 240 124 114 if entity @a[distance=..72] run particle minecraft:end_rod ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 167 120 700 if entity @a[distance=..72] run particle minecraft:end_rod ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 786 104 842 if entity @a[distance=..72] run particle minecraft:end_rod ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 328 108 42 if entity @a[distance=..72] run particle minecraft:enchant ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 458 112 232 if entity @a[distance=..72] run particle minecraft:enchant ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 399 113 738 if entity @a[distance=..72] run particle minecraft:enchant ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 501 109 913 if entity @a[distance=..72] run particle minecraft:enchant ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
execute positioned 887 104 915 if entity @a[distance=..72] run particle minecraft:enchant ~ ~ ~ 5 3 5 0.015 4 normal @a[distance=..72]
