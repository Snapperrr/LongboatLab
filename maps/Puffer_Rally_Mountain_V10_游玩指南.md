...
Minecraft Java 1.21.1 / Fabric / Longboat Lab 0.10.12 及以上。
地图目录：Puffer_Rally_Mountain_V10。这是独立新存档，旧版已游玩进度保留。
...
开局一格船、2 个河豚桶、4 把木铲、1 把重锤；首格留空并选中。黄色灯标指向可直接驶入的补给水港，靠近岸边箱子后空手右键，无需下船。
每港三种独立箱子：黄色河豚箱 4 桶、绿色木铲箱 6 把、蓝色船箱 2 艘。每人每局每箱各领一次，不抢占其他选手补给；先检查背包堆叠和空位，装不下则不扣领取资格。
