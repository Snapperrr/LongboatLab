...
execute positioned 199 64 615 unless entity @s[distance=..8] run return 0
execute if score @s lr_pit3 = #round lr_epoch run return 0
...
execute unless score #room lr_tmp matches 6.. run tellraw @s {"text":"需要6个背包空位。","color":"yellow","bold":false}
...
scoreboard players operation @s lr_pit3 = #round lr_epoch
tellraw @s {"text":"补给已领取。","color":"aqua","bold":false}
