...
execute positioned 209 64 623 unless entity @s[distance=..8] run return 0
execute if score @s lr_p3_boats = #round lr_epoch run return 0
...
scoreboard players operation @s lr_p3_boats = #round lr_epoch
