...
execute positioned 310 64 2 unless entity @s[distance=..8] run return 0
execute unless entity @s[tag=lr_free] if score @s lr_p2_fish = #round lr_epoch run return 0
...
scoreboard players operation @s lr_p2_fish = #round lr_epoch
