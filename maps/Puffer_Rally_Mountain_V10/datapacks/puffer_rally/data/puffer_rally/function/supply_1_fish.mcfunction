...
execute positioned 137 64 278 unless entity @s[distance=..8] run return 0
execute if score @s lr_p1_fish = #round lr_epoch run return 0
...
scoreboard players operation @s lr_p1_fish = #round lr_epoch
