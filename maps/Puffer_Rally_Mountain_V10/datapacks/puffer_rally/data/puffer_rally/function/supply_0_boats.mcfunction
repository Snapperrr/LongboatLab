...
execute positioned 27 64 81 unless entity @s[distance=..8] run return 0
execute if score @s lr_p0_boats = #round lr_epoch run return 0
...
scoreboard players operation @s lr_p0_boats = #round lr_epoch
