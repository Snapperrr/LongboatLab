...
execute if score #mounted lr_tmp matches 0 run summon minecraft:boat -24 63.85 1944 {Type:"oak",Tags:["lr_raceboat","lr_boat_a"],Rotation:[0f,0f],Invulnerable:0b,LongboatRig:{Segments:4,Width:1,LeftCount:8,RightCount:8,Compressed:1b,Puffers:0}}
