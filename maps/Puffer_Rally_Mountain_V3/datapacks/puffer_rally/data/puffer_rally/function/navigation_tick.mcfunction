...
execute as @a[tag=lr_racer,scores={lr_cp=43,lr_place=0}] at @s run function puffer_rally:nav_43
execute as @a[tag=lr_racer,scores={lr_cp=44,lr_place=0}] at @s run function puffer_rally:nav_44
execute as @a[tag=lr_racer,scores={lr_cp=45,lr_place=0}] at @s run function puffer_rally:nav_45
execute as @a[tag=lr_racer,scores={lr_cp=46,lr_place=0}] at @s run function puffer_rally:nav_46
execute as @a[tag=lr_racer,scores={lr_cp=47,lr_place=0}] at @s run function puffer_rally:nav_47
execute as @a[tag=lr_racer,scores={lr_cp=48,lr_place=0}] at @s run function puffer_rally:nav_48
execute as @a[tag=lr_racer,scores={lr_cp=49,lr_place=0}] at @s run function puffer_rally:nav_49
execute as @a[tag=lr_racer,scores={lr_cp=50,lr_place=0}] at @s run function puffer_rally:nav_50
execute as @a[tag=lr_racer,scores={lr_cp=51,lr_place=0}] at @s run function puffer_rally:nav_51
